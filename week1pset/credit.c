...
void luhnsalgorithm(void)
{
    ...
    // printf("%lu\n", sum);
    int lasttwodigitsforamex = cardnumber / 10000000000000;
    long lasttwodigits = cardnumber / 100000000000000;
    // printf("%i\n", lasttwodigits);
    if (number == 5 || number == 2)
    {
        if (sum % 10 == 0)
        {
            if (digits == 16)
            {
                if (lasttwodigits == 51 || lasttwodigits == 52 || lasttwodigits == 53 || lasttwodigits == 54 || lasttwodigits == 55)
                {
                    printf("MASTERCARD\n");
                }
                else
    ...
    else if (number == 3)
    {
        if (sum % 10 == 0)
        {
            if (digits == 15)
            {
                if (lasttwodigitsforamex == 34 || lasttwodigitsforamex == 37)
                {
                    printf("AMEX\n");
                }
                else
